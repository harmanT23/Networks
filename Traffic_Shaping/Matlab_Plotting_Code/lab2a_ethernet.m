...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[time_p, packetsize_p] = textread('output_ethernet_receiver.txt', '%f %f');
[time_p2, packetsize_p2] = textread('BC-pAug89-small.TL.txt', '%f %f');
[time_p3, packetsize_p3, bufferSize, tokens] = textread('bucketEthernet.txt', '%f %f %f %f');
...
subplot(3,1,3);
plot(time_p2(1:10000), bytesp)
title("Ethernet Arrival");
xlabel("time (s)");
ylabel("bytes");
