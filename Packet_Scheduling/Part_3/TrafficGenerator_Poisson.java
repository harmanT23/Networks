...
class TrafficGenerator_Poisson {
    ...
    public static void main (String[] args) {
        ...
        byte flow = Byte.parseByte(args[1]);
        ...
        try 
        {
			 ...
			 */
			FileOutputStream fout =  new FileOutputStream("output_poisson_sender" + flow + ".txt");
            pout = new PrintStream (fout);

            //Delay Params
            long startTime = System.nanoTime() + 273*1000/scale; //Add delay of first packet in ns
            ...
            while (outputPackets > 0 && (currentLine = bis.readLine()) != null) {
				...
				long Ftime  = Long.parseLong(col2) * 1000 / scale; //Convert from ms to ns
