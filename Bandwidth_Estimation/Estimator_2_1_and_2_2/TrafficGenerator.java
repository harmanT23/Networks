...
public class TrafficGenerator implements Runnable {
    ...
    private int r_; // average bit rate (kbps) of train;
    ...
    public TrafficGenerator(int srcPort, int sendPort, String sendIPAddress, int maxPacketSize, int N, int L, int r,
        ...
        this.L_ = L;
        this.r_ = r;
        this.T_ = (long) ((L * 8) / ((double)r * 1000) * 1000000000L);
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("Packet Train Sent!");
            socket.close();
        }
